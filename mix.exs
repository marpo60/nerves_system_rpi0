defmodule NervesSystemRpi0Marpo60.Mixfile do
  use Mix.Project
  ...
  def project do
    [app: :nerves_system_rpi0_marpo60,
     version: @version,
     elixir: "~> 1.3",
  ...
  defp package do
    ...
    files: ["LICENSE", "mix.exs", "nerves_defconfig", "nerves.exs", "README.md", "VERSION", "rootfs-additions", "fwup.conf", "cmdline.txt", "linux-4.4.defconfig", "config.txt", "post-createfs.sh"],
     licenses: ["Apache 2.0"],
     links: %{"Github" => "https://github.com/marpo60/nerves_system_rpi0_marpo60"}]
  end
end
